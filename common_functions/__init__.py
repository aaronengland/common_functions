...
def churn_trend(arr_identifier, arr_transaction_date, start_date, min_transaction_threshold=5, ecdf_threshold=0.9, plot_title='Proportion by Month'):
    ...
    # return attributes
    class attributes:
        def __init__(self, list_transaction_year_month_unique, df_results, b, trend_churned, fig):
    ...
    x = attributes(list_transaction_year_month_unique, df_results, b, trend_churned, fig)
    # return x 
    return x
...
def rolling_months_dates(date_today=datetime.date.today(), n_months=12):
