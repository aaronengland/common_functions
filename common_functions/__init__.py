...
def churn(arr_identifier, arr_transaction_date, identifier_name, end_date, min_transaction_threshold=5, ecdf_threshold=0.9):
    ...
    # print message
    print('\n')
    print('All {0} {1} with fewer than {2} transactions has been dropped.'.format(df_grouped_subset.shape[0]-df_grouped.shape[0],identifier_name, min_transaction_threshold))
